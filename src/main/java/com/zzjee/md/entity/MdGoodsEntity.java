...
//	@Excel(name="基准温度")
	...
	/*商品批次号*//*
    @Excel(name="商品批次号")
	private java.lang.String shpPiHao;
    *//**生产日期*//*
	@Excel(name="生产日期")
    private java.util.Date shengChanRiQi;*/
	/**nc主键*/
    ...
    /*@Column(name ="SHP_PI_HAO",nullable=true,length=32)
	public String getShpPiHao(){
	    return shpPiHao;
    }

    public void setShpPiHao(String shpPiHao){
	    this.shpPiHao = shpPiHao;
    }

	@Column(name ="SHENG_CHAN_RI_QI",nullable=true)
