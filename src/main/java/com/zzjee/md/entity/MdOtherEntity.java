 ...
 * @date 2019-12-19 11:38:00
 * @version V1.0   
 *
 */
@Entity
@Table(name = "md_other", schema = "")
@SuppressWarnings("serial")
public class MdOtherEntity implements java.io.Serializable {
	/**主键*/
	...
	/**废弃停用*/
	@Excel(name="废弃停用")
	private java.lang.String discard;
	/**明细*/
	@Excel(name="明细")
	...
	/**备注1*/
	@Excel(name="备注1")
	private java.lang.String remarks1;
	/**备注2*/
	@Excel(name="备注2")
	 ...
	 */
	@Column(name ="BARCODE",nullable=true,length=64)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  废弃停用
	 */
	@Column(name ="DISCARD",nullable=true,length=64)
	public java.lang.String getDiscard(){
		return this.discard;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  废弃停用
	 */
	public void setDiscard(java.lang.String discard){
	 ...
	 */
	@Column(name ="REMARKS1",nullable=true,length=64)
	 ...
	 */
	@Column(name ="REMARKS2",nullable=true,length=64)
