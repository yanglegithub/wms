...
//	@Excel(name="其他系统ID")
	...
	private java.util.Date goodsStoDate;
	/**库位整理*/
    @Excel(name="入库完成")
...
//	@Excel(name="保质期")
	...
	/**实际收货重量*/
	private java.lang.String goodsQmWeight;
	/**破包数*/
	private java.lang.String brokenCount;

	/**流程状态*/
	private java.lang.String bpmSta;
	/**
	...
	/**
	 *方法: 取得java.util.Date
	 *@return: java.util.Date  商品入库日期
	 */
	@Column(name ="GOODS_STO_DATE",nullable=true)
	public java.util.Date getGoodsStoDate(){
		return this.goodsStoDate;
	}

	/**
	 *方法: 设置java.util.Date
	 *@param: java.util.Date  商品入库日期
	 */
	public void setGoodsStoDate(java.util.Date goodsStoDate){
		this.goodsStoDate = goodsStoDate;
	}

	@Column(name ="GOODS_QMWEIGHT",nullable=true,length = 64)
	public String getGoodsQmWeight() {
		return goodsQmWeight;
	}

	public void setGoodsQmWeight(String goodsQmWeight) {
		this.goodsQmWeight = goodsQmWeight;
	}

	@Column(name ="BROKEN_COUNT",nullable=true,length = 64)
	...
	@Column(name ="BPM_STA",nullable=true,length = 64)
	public java.lang.String getBpmSta() {
		return bpmSta;
	}

	public void setBpmSta(java.lang.String bpmSta) {
		this.bpmSta = bpmSta;
	}
