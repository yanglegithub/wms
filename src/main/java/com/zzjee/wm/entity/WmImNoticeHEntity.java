...
public class WmImNoticeHEntity implements java.io.Serializable {
	...
	/**排产时生成的订单号，成品入库关联排产任务*/
	private java.lang.String orderNum;
	/**已经推送给NC:Y,N*/
	private java.lang.String hasPushedNC;
	/**nc入库单主键*/
	...
	@Column(name ="HAS_PUSHED_NC",nullable=true,length=32)
	public String getHasPushedNC() {
		return hasPushedNC;
	}

	public void setHasPushedNC(String hasPushedNC) {
		this.hasPushedNC = hasPushedNC;
	}
