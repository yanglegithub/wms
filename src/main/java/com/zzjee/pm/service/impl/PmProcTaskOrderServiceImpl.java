...
@Service("pmProcTaskOrderService")
@Transactional
public class PmProcTaskOrderServiceImpl extends CommonServiceImpl implements PmProcTaskOrderServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(PmProcTaskOrderEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(PmProcTaskOrderEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(PmProcTaskOrderEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(PmProcTaskOrderEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,PmProcTaskOrderEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("pm_proc_task_order",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
