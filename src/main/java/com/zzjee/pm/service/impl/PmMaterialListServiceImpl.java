...
@Service("pmMaterialListService")
@Transactional
public class PmMaterialListServiceImpl extends CommonServiceImpl implements PmMaterialListServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(PmMaterialListEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(PmMaterialListEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(PmMaterialListEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(PmMaterialListEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,PmMaterialListEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("pm_material_list",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
