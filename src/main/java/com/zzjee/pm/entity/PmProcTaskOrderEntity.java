...
/**   
 * @Title: Entity
 * @Description: 排产任务所生生产订单
 * @author onlineGenerator
 * @date 2019-12-08 23:51:30
 * @version V1.0   
 *
 */
@Entity
@Table(name = "pm_proc_task_order", schema = "")
@SuppressWarnings("serial")
public class PmProcTaskOrderEntity implements java.io.Serializable {
	/**主键*/
