...
//			httpUrlConn.setRequestProperty("content-type", "text/html");
	...
	public static void main(String args[]){
		...
		String url = "http://localhost:8077/wms/api/V1/pushOutOrder.do";

		String jsonStr = "\t{\n" +
				"\t\t\t\"qcstaff\": \"\",\n" +
				"\t\t\t\t\"erp_baseid\": \"2143AA10000000008N49\",\n" +
				"\t\t\t\t\"list\": [{\n" +
				"\t\t\t\"invbasid\": \"000121100000001G9A0H\",\n" +
				"\t\t\t\t\t\"outQuantity\": \"10.00\",\n" +
				"\t\t\t\t\t\"outWeight\": \"250.00\",\n" +
				"\t\t\t\t\t\"prodectName\": \"艾微锌（25KG）\",\n" +
				"\t\t\t\t\t\"productId\": \"30016606000019\"\n" +
				"\t\t}],\n" +
				"\t\t\t\"orderKey\": \"2143AA10000000008MYJ\",\n" +
				"\t\t\t\t\"outDate\": \"2019-12-23\"" +
				"}";
