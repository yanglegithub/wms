	...
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="mdGoodsController.do?doAdd" tiptype="1" >
			...
			<div class="tab-wrapper">
			    ...
			    <ul class="nav nav-tabs">
			      <li role="presentation" class="active"><a href="javascript:void(0);">物料信息</a></li>
			      ...
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<input id="shpBianMakh" name="shpBianMakh" type="text" class="form-control"
								   ...
								   />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
						<label class="Validform_label" style="display: none">客户物料编码</label>
			          </div>
										          <div class="col-xs-3 text-center">
			          	<b  >物料条码</b>
			          </div>
			          <div class="col-xs-3">
						...
						<label class="Validform_label" style="display: none">物料条码</label>
								...
								<div class="col-xs-3">
									...
									/>
									<span class="Validform_checktip" style="float:left;height:0px;"></span>
									<label class="Validform_label" style="display: none">物料规格</label>
								</div>
								<div class="col-xs-3 text-center">
									<b  >物料品牌</b>
								</div>
								<div class="col-xs-3">
									...
									/>
									<span class="Validform_checktip" style="float:left;height:0px;"></span>
									<label class="Validform_label" style="display: none">物料品牌</label>
								</div>
								<div class="col-xs-3 text-center">
									<b  >物料批次号</b>
								</div>
								<div class="col-xs-3">
									<input id="shpPiHao" name="shpPiHao" type="text" class="form-control"
											ignore="ignore"
									/>
									<span class="Validform_checktip" style="float:left;height:0px;"></span>
									<label class="Validform_label" style="display: none">物料批次号<</label>
								</div>
						</div>
			          ...
			          <div class="col-xs-3">
								...
								dictTable="ba_goods_class" dictField="goods_class_code" dictText="goods_class_name" hasLabel="false"  title="计费物料类"></t:dictSelect>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
						<label class="Validform_label" style="display: none">计费物料类</label>
			          </div>
