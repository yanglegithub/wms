...
<div class="easyui-layout" fit="true">
  ...
  <div region="center" style="padding:0px;border:0px">
    <t:datagrid name="mdGoodsList" checkbox="true"  fitColumns="false" title="物料信息" actionUrl="mdGoodsController.do?datagrid" idField="id" fit="false" queryMode="group">
    ...
    <t:dgCol title="原料/成品名称"  field="shpMingCheng"   query="true" queryMode="single"  width="160"></t:dgCol>
    ...
    <t:dgCol title="原料/成品批次号"  field="shpPiHao"   query="true" queryMode="single"  width="90"></t:dgCol>

    <t:dgCol title="原料/成品简称"  field="shpJianCheng"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
    <t:dgCol title="原料/成品编码"  field="shpBianMa"   query="true" queryMode="single"  width="90"></t:dgCol>
    <t:dgCol title="客户原料/成品编码"  field="shpBianMakh"   query="true" queryMode="single"  width="90"></t:dgCol>
    <t:dgCol title="原料/成品批次号"  field="shpPiHao"   query="true" queryMode="single"  width="90"></t:dgCol>

    <t:dgCol title="原料/成品型号"  field="shpXingHao"  hidden="true"  queryMode="group"  width="120"></t:dgCol>
    <t:dgCol title="原料/成品规格"  field="shpGuiGe"   queryMode="group"  width="80"></t:dgCol>
    <t:dgCol title="原料/成品颜色"  field="shpYanSe"  hidden="true"  queryMode="group"  width="120"></t:dgCol>
    ...
    <t:dgCol title="计费原料/成品类"  field="jfShpLei"    queryMode="group" dictionary="ba_goods_class,goods_class_code,goods_class_name"  width="70"></t:dgCol>
    <t:dgCol title="原料/成品品牌"  field="shpPinPai"  hidden="true"  queryMode="group" dictionary="ba_goods_brand,goods_brand_code,goods_brand_name"  width="120"></t:dgCol>
    <t:dgCol title="原料/成品条码"  field="shpTiaoMa"    queryMode="group"  width="120"></t:dgCol>
    ...
    <t:dgCol title="原料/成品描述"  field="shpMiaoShu"  hidden="true"  queryMode="group"  width="120"></t:dgCol>
...
<%--    <t:dgToolBar title="批量删除"  icon="icon-remove" url="mdGoodsController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar> --%>
   ...
   <t:dgToolBar title="导入" icon="icon-put" funname="ImportXls"></t:dgToolBar>
    <t:dgToolBar operationCode="uasimpgoods" title="NC系统导入" icon="icon-put" funname="importFromNc"></t:dgToolBar>
   ...
   <t:dgToolBar title="模板下载" icon="icon-putout" funname="ExportXlsByT"></t:dgToolBar>
      ...
      <div name="searchColums1" style="float: left; padding-left: 0px;padding-top: 5px;">
          ...
          原料/成品编码：<input type="text" name="othercode"    class="form-control"  style="width: 100px; height: 30px;">
 ...
 $(document).ready(function(){
	...
	//从NC系统导入
	function importFromNc(){
		  var url = "mdGoodsController.do?getFromNc";
          $.ajax({
              cache : false,
              type : 'POST',
              url : url,// 请求的action路径
 ...
 function doprint(id){
     ...
     createdetailwindow(" 原料/成品标签", url, 400, 300);
