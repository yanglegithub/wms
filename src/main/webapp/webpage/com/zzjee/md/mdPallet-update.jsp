...
<head>
 ...
 <body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="mdPalletController.do?doUpdate" tiptype="1" >
			<input type="hidden" id="btn_sub" class="btn_sub"/>
			<input type="hidden" name="id" value='${mdPalletPage.id}' >
			      ...
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<input id="tuoPanBianMa" name="tuoPanBianMa" type="text" class="form-control"
									ignore="checked"
								   datatype="*" value='${mdPalletPage.tuoPanBianMa}' />
			          ...
			          <div class="col-xs-3">
								<input id="tuoPanTiaoMa" name="tuoPanTiaoMa" type="text" class="form-control"
									ignore="checked"
								   datatype="*" value='${mdPalletPage.tuoPanTiaoMa}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<t:dictSelect field="tuoPanLeiXing" type="list" extendJson="{class:'form-control'}"
								dictTable="ba_pallet_type" dictField="type_code" dictText="type_name" defaultVal="${mdPalletPage.tuoPanLeiXing}" hasLabel="false"  title="托盘类型"></t:dictSelect>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<t:dictSelect field="tuoPanZhuangTai" type="list" extendJson="{class:'form-control'}"
								typeGroupCode="pal_status" defaultVal="${mdPalletPage.tuoPanZhuangTai}" hasLabel="false"  title="托盘状态"></t:dictSelect>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="zhuangLiaoBianMa" name="zhuangLiaoBianMa" type="text" class="form-control"
									ignore="ignore"
								   value='${mdPalletPage.zhuangLiaoBianMa}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="zhuangLiaoMingCheng" name="zhuangLiaoMingCheng" type="text" class="form-control"
									ignore="ignore"
								   value='${mdPalletPage.zhuangLiaoMingCheng}' />
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<t:dictSelect field="shuLiangDanWei" type="list" extendJson="{class:'form-control'}"
								dictTable="ba_unit" dictField="unit_code" dictText="unit_zh_name" defaultVal="${mdPalletPage.shuLiangDanWei}" hasLabel="false"  title="数量单位"></t:dictSelect>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<t:dictSelect field="zhongLiangDanWei" type="list" extendJson="{class:'form-control'}"
								typeGroupCode="w_unit" defaultVal="${mdPalletPage.zhongLiangDanWei}" hasLabel="false"  title="重量单位"></t:dictSelect>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<%--<input id="binBianMa" name="binBianMa" type="text" class="form-control"--%>
									<%--ignore="ignore"--%>
								   <%--value='${mdPalletPage.binBianMa}' />--%>
									<t:dictSelect field="binBianMa" type="list" extendJson="{class:'form-control easyui-combobox'}" defaultVal="${mdPalletPage.binBianMa}"
			          ...
			          <div class="col-xs-3">
								<%--<input id="binTiaoMa" name="binTiaoMa" type="text" class="form-control"--%>
									<%--ignore="ignore"--%>
								   <%--value='${mdPalletPage.binTiaoMa}' />--%>
									<t:dictSelect field="binTiaoMa" type="list" extendJson="{class:'form-control easyui-combobox'}" defaultVal="${mdPalletPage.binTiaoMa}"
			          ...
			          <div class="col-xs-3">
								...
								typeGroupCode="sf_yn" defaultVal="${mdPalletPage.tingYong}" hasLabel="false"  title="停用"></t:dictSelect>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
