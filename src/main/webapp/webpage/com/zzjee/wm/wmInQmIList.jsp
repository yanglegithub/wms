 ...
 <div region="center" style="padding:0px;border:0px">
  <t:datagrid name="wmInQmIList"  checkbox="true" pagination="true" fitColumns="false" title="批量收货" actionUrl="wmInQmIController.do?datagrid" idField="id" fit="false"  queryMode="group">
   <t:dgCol title="操作" field="opt" width="120"></t:dgCol>
    ...
    <t:dgCol title="验收人"  field="createName"  hidden="true"   queryMode="single"  width="80"></t:dgCol>
    <t:dgCol title="创建人登录名称"  field="createBy"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
    <t:dgCol title="入库日期"  field="createDate" formatter="yyyy-MM-dd hh:mm:ss"   queryMode="single"  width="130"></t:dgCol>
    ...
    <t:dgCol title="入库单号"  field="imNoticeId"  query="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="客户订单号"  field="imCusCode" hidden="true" queryMode="single"  width="90"></t:dgCol>

   <t:dgCol title="入库明细"  field="imNoticeItem"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
    <t:dgCol title="原料/成品编码"  field="goodsId"     query="true"     width="100"></t:dgCol>
   <t:dgCol title="原料/成品名称"  field="goodsName"     query="true" queryMode="single"  width="220"></t:dgCol>
   <t:dgCol title="入库数量"  field="imQuat"    queryMode="single"  width="80"></t:dgCol>
    <t:dgCol title="入库确认数量"  field="qmOkQuat"    queryMode="single"  width="80"></t:dgCol>
    ...
    <t:dgCol title="货主"  field="cusCode"  hidden="true" queryMode="single" dictionary="mv_cus,cus_code,cus_name"  width="180"></t:dgCol>
