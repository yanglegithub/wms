...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wmOmNoticeHList" checkbox="true" fitColumns="true" title="出库通知 -默认显示前后7天数据" actionUrl="wmOmNoticeHController.do?datagrid" idField="id" fit="true" queryMode="group">
