...
<div   class="easyui-layout" fit="true">
  ...
  <t:datagrid name="wmInQmIbatchList" checkbox="true" pagination="false" fitColumns="true" title="退货登记" actionUrl="wmImNoticeHController.do?datagridtbatch" idField="id" fit="true" queryMode="group">
   <t:dgCol title="操作" field="opt" width="50"></t:dgCol>
    ...
    <t:dgCol title="入库单"  field="imNoticeId"  query="true"  queryMode="single"  width="120"></t:dgCol>
    <t:dgCol title="原料/成品编码"  field="goodsCode"  query="true"    queryMode="single"    width="100"></t:dgCol>
      <t:dgCol title="原料/成品名称"  field="goodsName"  query="true"    queryMode="single"    width="250"></t:dgCol>
