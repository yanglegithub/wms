...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:0px;border:0px">
    <t:datagrid name="wmOmNoticeHList" checkbox="true" fitColumns="false" title="出库单" actionUrl="wmOmNoticeHController.do?datagrid" idField="id" fit="false" queryMode="group">
      ...
      <t:dgCol title="货主"  field="cusCode" hidden="true"     queryMode="single"  dictionary="mv_cus,cus_code,cus_name" width="120"></t:dgCol>
      <t:dgCol title="客户订单号"  field="imCusCode"  hidden="true" queryMode="single"  width="100"></t:dgCol>
      <t:dgCol title="备注"  field="omBeizhu" query="true"   queryMode="single"  width="120"></t:dgCol>
      <t:dgCol title="订单类型" field="orderType" query="true" queryMode="single" width="120"></t:dgCol>
      <t:dgCol title="品管人" field="qcStuff" hidden="true" queryMode="single" width="120"></t:dgCol>
      <t:dgCol title="排产任务编码" field="taskCode" hidden="true" queryMode="single" width="120"></t:dgCol>

      <t:dgCol title="三方客户编码"  field="ocusCode"   hidden="true" queryMode="single"  width="90"></t:dgCol>
      <t:dgCol title="三方客户"  field="ocusName"   hidden="true" queryMode="single"  width="90"></t:dgCol>

      <t:dgCol title="要求交货时间"  field="delvData"  formatter="yyyy-MM-dd hh:mm:ss"    hidden="true" queryMode="group"  width="120"></t:dgCol>
      <t:dgCol title="收货人"  field="delvMember"   hidden="true" queryMode="single"  width="60"></t:dgCol>
      <t:dgCol title="收货人电话"  field="delvMobile"   hidden="true" queryMode="single"  width="90"></t:dgCol>
      <t:dgCol title="收货人地址"  field="delvAddr"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
      <t:dgCol title="运输公司"  field="reMember"  hidden="true" dictionary="tms_kd" queryMode="single"  width="60"></t:dgCol>
      <%--<t:dgCol title="承运人电话"  field="reMobile"   query="true" queryMode="single"  width="60"></t:dgCol>--%>
      <t:dgCol title="发货运单号"  field="reCarno"   hidden="true" queryMode="single"  width="60"></t:dgCol>
