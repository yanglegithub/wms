...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid pageSize="50"  name="wmOmQmIList" checkbox="true" pagination="true" fitColumns="false" title="下架任务" actionUrl="wmOmQmIController.do?datagrid" idField="id" fit="true" queryMode="group">
    ...
    <t:dgCol title="创建日期"  field="createDate" hidden="true" formatter="yyyy-MM-dd hh:mm:ss"   queryMode="group"  width="80"></t:dgCol>
    <t:dgCol title="更新人"  field="updateName"  hidden="true"   queryMode="group"  width="120"></t:dgCol>
    <t:dgCol title="更新人登录名称"  field="updateBy"  hidden="true"  queryMode="group"  width="120"></t:dgCol>
    <t:dgCol title="更新时间"  field="updateDate" hidden="true" formatter="yyyy-MM-dd hh:mm:ss"    queryMode="group"  width="130"></t:dgCol>
