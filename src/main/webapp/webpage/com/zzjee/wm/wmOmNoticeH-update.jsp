		...
		<input id="updateName" name="updateName" type="hidden" value="${wmOmNoticeHPage.updateName }"/>
			<div class="tab-wrapper">
			    ...
			    <ul class="nav nav-tabs">
			      <li role="presentation" class="active"><a href="javascript:void(0);">出库单</a></li>
...
<div id="jform_tab" class="tab-wrapper">
	<!-- tab -->
    <ul class="nav nav-tabs">
	   	<li role="presentation" tab-ajax-url="wmOmNoticeHController.do?wmOmNoticeIList&omNoticeId=${wmOmNoticeHPage.omNoticeId}"><a href="#con-wrapper0">出库明细</a></li>
