        ...
        <div class="row show-grid">
          ...
          <div class="col-xs-2">
            <t:dictSelect readonly="${wmImNoticeHPage.readonly}" field="cusCode" type="list"
                          ...
                          dictText="cus_name" hasLabel="false" title="客户编码"></t:dictSelect>
        ...
        <div class="row show-grid">
          ...
          <div class="col-xs-2">
            <t:dictSelect field="orderTypeCode" type="list" extendJson="{class:'form-control',style:'width:150px'}"
                          ...
                          defaultVal="${wmImNoticeHPage.orderTypeCode}" hasLabel="false" title="订单类型"></t:dictSelect>
            <span class="Validform_checktip" style="float:left;height:0px;"></span>
          ...
          <div class="col-xs-2">
            <t:dictSelect field="platformCode" type="list" extendJson="{class:'form-control',style:'width:150px'}"
                          dictTable="ba_platform" dictField="platform_code" dictText="platform_name"
                          hasLabel="false" title="月台"></t:dictSelect>
            <span class="Validform_checktip" style="float:left;height:0px;"></span>
...
<table style="display:none">
  ...
  <tr>
    ...
    <td align="left">
      ...
      <label class="Validform_label" style="display: none;">物料/成品编码</label>
    </td>
    <td align="left">
    ...
    <td align="left">
      <input name="wmImNoticeIList[#index#].goodsWeight" maxlength="32"
             ignore="ignore" datatype="*"
             type="text" class="form-control" style="width:120px;text-align: right">
    ...
    <td align="left">
      ...
      <t:dictSelect field="wmImNoticeIList[#index#].goodsUnit" type="list" extendJson="{class:'form-control'}"
                    dictTable="ba_unit" dictField="unit_code" dictText="unit_zh_name" hasLabel="false"
                    title="单位"></t:dictSelect>
	...
	<td align="left">
      <input name="wmImNoticeIList[#index#].goodsBatch" maxlength="32"
             ignore="ignore" datatype="*"
             type="text" class="form-control" style="width:120px;text-align: right">
    ...
    <td align="left">
      <input name="wmImNoticeIList[#index#].goodsPrdData" maxlength="32"
             ...
             style="background: url('plug-in/ace/images/datetime.png') no-repeat scroll right center transparent;width:160px;"
             ignore="ignore">
    ...
    <td align="left">
      ...
      <label class="Validform_label" style="display: none;">入库完成</label>
    </td>
