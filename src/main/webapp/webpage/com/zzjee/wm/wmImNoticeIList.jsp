				...
				<td><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td>
					  ...
					  <label class="Validform_label" style="display: none;">数量</label>
 				   	...
 				   	<td> 
 							<t:dictSelect name="wmImNoticeIList[0].goodsUnit" type="list" extendJson="{class:'form-control',style:'width:250px'}" 
 				   ...
 				   <td> 
 						<input name="wmImNoticeIList[0].goodsPrdData" maxlength="32" 
				  ...
				  <td>
							<t:dictSelect field="wmImNoticeIList[0].binPre" type="radio" extendJson="{class:'form-control',style:'width:150px'}"
										typeGroupCode="sf_yn" defaultVal="N" hasLabel="false"  title="入库完成"></t:dictSelect>
		...
		<c:forEach items="${wmImNoticeIList}" var="poVal" varStatus="stuts">
			...
			<%-- 					<input name="wmImNoticeIList[${stuts.index }].goodsUnit" type="hidden" value="${poVal.goodsUnit }"/> --%>
				   <td align="left">
					  ...
					  <label class="Validform_label" style="display: none;">原料/成品编码</label>
...
<%-- 				  				<t:choose  hiddenName="wmImNoticeIList[${stuts.index }].goodsCode" hiddenid="goodsName" url="mvGoodsController.do?list" name="mvGoodsList" width="900"  height="610" icon="icon-search" title="选择" textname="goodsName"  isInit="true"></t:choose> --%>
				   ...
				   <td align="left">
					  	<input name="wmImNoticeIList[${stuts.index }].goodsWeight" maxlength="32"  datatype="*"  
					  		type="text" class="form-control"  style="width:120px;text-align: right"  value="${poVal.goodsWeight }">
				    ...
				    <td align="left">
					  	<input name="wmImNoticeIList[${stuts.index }].goodsBatch" maxlength="32"  datatype="*"  
					  		type="text" class="form-control"  style="width:120px;text-align: right"  value="${poVal.goodsBatch }">
