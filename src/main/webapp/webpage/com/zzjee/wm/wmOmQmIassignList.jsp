...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid pageSize="500" name="wmOmQmIList" checkbox="true" pagination="true" fitColumns="false" title="待确认下架任务" actionUrl="wmOmQmIController.do?datagridassign" idField="id" fit="true" queryMode="group">
    ...
    <t:dgCol title="创建日期"  field="createDate" hidden="true"  formatter="yyyy-MM-dd"   queryMode="group"  width="80"></t:dgCol>
    <t:dgCol title="更新人名称"  field="updateName" hidden="true"    queryMode="group"  width="80"></t:dgCol>
    <t:dgCol title="更新人登录名称"  field="updateBy"  hidden="true"  queryMode="group"  width="120"></t:dgCol>
    <t:dgCol title="更新日期"  field="updateDate" hidden="true"  formatter="yyyy-MM-dd"  queryMode="group"  width="80"></t:dgCol>
    ...
    <t:dgCol title="原料/成品编码"  field="goodsId"   query="true"     queryMode="single"  width="100"></t:dgCol>
      <t:dgCol title="原料/成品名称"  field="goodsName"   query="true"    queryMode="single"  width="200"></t:dgCol>
...
<%--   <t:dgFunOpt title="下架" funname="wmtodown(id)"  urlclass="ace_button"   exp="binSta#ne#Y"/> --%>
 <%--   <t:dgDelOpt title="录入" url="wmOmQmIController.do?doDel&id={id}"  exp="binSta#ne#Y" urlclass="ace_button"  urlfont="fa-trash-o"/>    <t:dgToolBar title="录入" icon="icon-add" url="wmOmQmIController.do?goAdd" funname="add"></t:dgToolBar> --%>
