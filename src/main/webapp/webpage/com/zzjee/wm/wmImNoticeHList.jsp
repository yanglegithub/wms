...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:0px;border:0px">
    <t:datagrid name="wmImNoticeHList" checkbox="true" fitColumns="false" title="入库单" actionUrl="wmImNoticeHController.do?datagrid" idField="id" fit="false" queryMode="group">
      ...
      <t:dgCol title="入库单号"  field="noticeId" query="true" sortable="true"    queryMode="single"  width="120"></t:dgCol>
      <t:dgCol title="客户编码"  field="cusCode"  query="true"   queryMode="single" dictionary="mv_cus,cus_code,cus_name"  width="200"></t:dgCol>
      <t:dgCol title="入库时间"  field="imData" formatter="yyyy-MM-dd hh:mm:ss"  query="true" queryMode="group"  width="120"></t:dgCol>
      <t:dgCol title="客户订单号"  field="imCusCode" hidden="true" queryMode="single"  width="90"></t:dgCol>
      <t:dgCol title="运输号码"  field="imCarNo" hidden="true" queryMode="single"  width="50"></t:dgCol>
      <t:dgCol title="运输公司"  field="imCarDri" hidden="true" queryMode="single"  width="50"></t:dgCol>
      <t:dgCol title="供应商编号"  field="supCode"  hidden="true" queryMode="single"  width="100"></t:dgCol>

      <t:dgCol title="供应商名称"  field="supName" hidden="true"  queryMode="single"  width="120"></t:dgCol>
      <t:dgCol title="品管人"  field="qcStuff"  queryMode="single"  width="120"></t:dgCol>
      <t:dgCol title="排产任务编码"  field="taskCode"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
      ...
      <t:dgConfOpt title="删除" url="wmImNoticeHController.do?doDel&id={id}"  urlclass="ace_button" message="确定要删除此收货通知" urlfont="fa-trash-o" exp="imSta#eq#确认中"/>
      <%--<t:dgFunOpt title="预约通知" funname="print(id)"  urlclass="ace_button"  urlfont="	fa-print" exp="imSta#ne#已删除"/>--%>
      <t:dgFunOpt title="入库单" funname="doprint(id)"  urlclass="ace_button"   exp="imSta#ne#已删除"   />
     ...
     <%--  <t:dgFunOpt title="验收单" funname="printysd(id)"  urlclass="ace_button"  urlfont="	fa-print" exp="imSta#ne#已删除"/> --%>
      ...
      <t:dgFunOpt title="完成" funname="closeor(id)"  urlclass="ace_button"     exp="imSta#ne#已确认"/>
      <t:dgFunOpt title="审核" funname="appor(id)"  urlclass="ace_button"     exp="imSta#eq#初始化"/>
      <t:dgFunOpt title="回写" funname="dopost(id)"  urlclass="ace_button"     exp="imSta#eq#已确认"/>
...
<script type="text/javascript">
    ...
    function doprint(id){
        ...
        createdetailwindow(" 入库单", url, 1200, 1000);

        // window.open(url);
    }
    function addorder(){
        var url = "wmImNoticeHController.do?goAdd&orderTypeCode=01";
        openwindow("添加",url,"入库",770,500);
    }
    function ImportXls() {
