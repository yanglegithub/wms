			...
			<tr>
				...
				<td><input style="width:20px;" type="checkbox" name="ck"/></td>
				  <td>
					  ...
					  <label class="Validform_label" style="display: none;">出库原料/成品</label>
					</td>
				  <td>
					...
					<td>
					  	<input name="wmOmNoticeIList[0].goodsWeight" maxlength="32" 
					  		type="text" class="form-control"  style="width:120px;" >
					  <label class="Validform_label" style="display: none;">出库重量</label>
					</td>
					<td>
					...
					<td>
					  	<input name="wmOmNoticeIList[0].goodsBatch" maxlength="32" 
					  		type="text" class="form-control"  style="width:120px;" >
