...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid sortName="resDate" sortOrder="asc" name="mvStockYjList" checkbox="true" pagination="true" fitColumns="false" title="效期预警" actionUrl="mvStockYjController.do?datagrid" idField="id" fit="true" queryMode="group">
    ...
    <t:dgCol title="客户商品编码"  field="shpBianmakh"  hidden="true"   queryMode="single"   width="100"></t:dgCol>
    <t:dgCol title="原料/成品名称"  field="shpMingCheng"  query="true"   queryMode="single"  width="300"></t:dgCol>
    ...
    <t:dgCol title="客户编码"  field="cusCode"   queryMode="single"   width="80"></t:dgCol>
    <t:dgCol title="客户名称"  field="zhongWenQch"    queryMode="single"  width="120"></t:dgCol>
